...
Visual Anchor (Top 40%): A conceptual high-tech visualization of Data Refraction. A single stream of 48 Glowing Orbs flows into a crystalline Data Prism. As it exits, it splits into two beams: Top Beam (Blue) displays "25 ODD / 23 EVEN", Bottom Beam (Orange) displays "23 ODD / 25 EVEN".

Negative Space (Bottom 60%): The prism glow fades downwards into a clean, deep Obsidian Void, creating a massive dark canvas below.
